...
export const config: EventConfig = {
	...
	description:
		"basic-tutorial event step, demonstrates how to consume an event from a topic and persist data in state",
...
export const handler: Handlers["ProcessFoodOrder"] = async (
	input,
